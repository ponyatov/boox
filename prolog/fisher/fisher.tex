...
\secrel{1. How to Run Prolog }
\secrel{2. Sample Programs -- Descriptions}\secdown
...
\secup
\secrel{5. Search in Prolog}\secdown
\secrel{5.1 The A* algorithm in Prolog} 
\secrel{5.2 The 8-puzzle} 
\secrel{5.3 $\alpha\beta$ search in Prolog}
\secup
\secrel{6. Logic Topics}\secdown
...
\secup
\secrel{7. Introduction to Natural Language Processing}\secdown
...
\secup
\secrel{8. Prototyping with Prolog}\secdown
...
\secrel{8.4 Java Tic-Tac-Toe GUI plays against Prolog opponent (\$5.3)} 
