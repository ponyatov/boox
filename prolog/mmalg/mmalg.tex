...
\input{prolog/mmalg/32trans}
\input{prolog/mmalg/33solving}
\input{prolog/mmalg/34uni}
\secup
\input{prolog/mmalg/4eff}
\input{prolog/mmalg/5improv}
\input{prolog/mmalg/6impl}
\input{prolog/mmalg/7compar}
\input{prolog/mmalg/8con}
